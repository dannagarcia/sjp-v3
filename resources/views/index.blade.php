                        ...
                        @if($top_five)
                            @foreach ($top_five as $events => $event_value)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/event/{{$event_value->id}}" class="btn btn-success btn-xs">View Event
                                            Details</a>
                                    </td>
                                </tr>
                            @endforeach
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <h2 class="dashb-title page-header">{{$alumni->first_name}} {{$alumni->last_name}},
                            <em>{{$alumni->alumni_type}}</em></h2>
                        <ul class="details">
